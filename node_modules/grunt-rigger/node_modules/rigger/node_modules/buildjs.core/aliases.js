var regexes = require('./regexes'),
    reAlias = regexes.alias;

/**
## expand(input, aliases)

The expand function is used to locate aliases within the given input string and return
...
var expand = exports.expand = function(input, aliases) {
    ...
    if (match) {
        ...
        */
        ...
        input = expand(base + '/' + match[2].replace(regexes.leadingSlash, ''), aliases);
